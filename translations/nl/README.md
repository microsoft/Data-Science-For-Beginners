...
1. Als dit de eerste keer is dat je een ontwikkelcontainer gebruikt, zorg er dan voor dat je systeem aan de vereisten voldoet (bijv. Docker geïnstalleerd) in [de getting started documentatie](https://code.visualstudio.com/docs/devcontainers/containers#_getting-started).
