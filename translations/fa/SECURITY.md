...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-23T23:19:48+00:00",
...
اگر فکر می‌کنید که یک آسیب‌پذیری امنیتی در هر مخزن متعلق به مایکروسافت پیدا کرده‌اید که مطابق با [تعریف آسیب‌پذیری امنیتی مایکروسافت](https://docs.microsoft.com/en-us/previous-versions/tn-archive/cc751383(v=technet.10)) است، لطفاً آن را به ما گزارش دهید، همان‌طور که در زیر توضیح داده شده است.
