...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-23T23:14:04+00:00",
...
را یاد بگیرید. طبق معمول، هر درس شامل تکالیف، بررسی دانش و چالش‌ها است.
...
- [صفحه مرکز دانشجویی](https://docs.microsoft.com/en-gb/learn/student-hub?WT.mc_id=academic-77958-bethanycheum) در این صفحه، منابع مبتدی، بسته‌های دانشجویی و حتی راه‌هایی برای دریافت یک کوپن گواهی رایگان را پیدا خواهید کرد. این صفحه‌ای است که باید نشانک‌گذاری کنید و هر از گاهی بررسی کنید، زیرا ما حداقل ماهانه محتوا را تغییر می‌دهیم.
...
> **[دانشجویان](https://aka.ms/student-page)**: برای استفاده از این برنامه آموزشی به‌صورت مستقل، کل مخزن را فورک کنید و تمرین‌ها را به‌صورت مستقل تکمیل کنید، با آزمون قبل از درس شروع کنید. سپس درس را بخوانید و بقیه فعالیت‌ها را تکمیل کنید. سعی کنید پروژه‌ها را با درک درس‌ها ایجاد کنید، نه با کپی کردن کد راه‌حل؛ با این حال، آن کد در پوشه‌های /solutions در هر درس مبتنی بر پروژه موجود است. ایده دیگر این است که یک گروه مطالعه با دوستان تشکیل دهید و با هم محتوا را مرور کنید. برای مطالعه بیشتر، ما [Microsoft Learn](https://docs.microsoft.com/en-us/users/jenlooper-2911/collections/qprpajyoy3x0g7?WT.mc_id=academic-77958-bethanycheum) را توصیه می‌کنیم.
...
> [قوانین رفتاری](CODE_OF_CONDUCT.md)، [مشارکت](CONTRIBUTING.md)، [راهنمای ترجمه](TRANSLATIONS.md) ما را پیدا کنید. ما مشتاقانه منتظر بازخورد سازنده شما هستیم!
...
|:---:|
| علوم داده برای مبتدیان: نقشه راه - _اسکچ‌نوت توسط [@nitya](https://twitter.com/nitya)_ |
...
| 13 | مصورسازی‌های معنادار | [مصورسازی داده](3-Data-Visualization/README.md) | تکنیک‌ها و راهنمایی‌هایی برای ارزشمند کردن مصورسازی‌ها جهت حل مؤثر مسائل و دستیابی به بینش‌ها. | [درس](3-Data-Visualization/13-meaningful-visualizations/README.md) | [جن](https://twitter.com/jenlooper) |
...
یا نسخه‌ای کلون‌شده یا دانلودشده از مخزن را به صورت محلی باز کنید:
