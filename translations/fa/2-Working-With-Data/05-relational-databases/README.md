...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-23T23:23:26+00:00",
...
در حالی که این روش از تکرار ردیف‌ها جلوگیری می‌کند، چند چالش دیگر را اضافه می‌کند. ما باید هر بار که سال جدیدی وجود دارد ساختار جدول خود را تغییر دهیم. علاوه بر این، با رشد داده‌های ما، داشتن سال‌ها به عنوان ستون‌ها باعث می‌شود بازیابی و محاسبه مقادیر دشوارتر شود.
...
ما دو ستون مورد نظر و این واقعیت که می‌خواهیم جداول را با **city_id** به هم وصل کنیم برجسته کرده‌ایم. اکنون می‌توانیم عبارت `WHERE` را اضافه کنیم تا فقط سال ۲۰۱۹ را فیلتر کنیم.
