...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-05T05:52:40+00:00",
...
V tejto lekcii preskúmame aplikácie dátovej vedy v rôznych odvetviach a ponoríme sa do konkrétnych príkladov v oblasti výskumu, digitálnych humanitných vied a udržateľnosti. Pozrieme sa na príležitosti pre študentské projekty a zakončíme užitočnými zdrojmi, ktoré vám pomôžu pokračovať vo vašej vzdelávacej ceste!
...
Vďaka demokratizácii AI je pre vývojárov teraz jednoduchšie navrhovať a integrovať rozhodovanie poháňané AI a poznatky založené na dátach do používateľských skúseností a vývojových pracovných postupov. Tu je niekoľko príkladov, ako sa dátová veda "aplikuje" na reálne aplikácie v priemysle:

 * [Google Flu Trends](https://www.wired.com/2015/10/can-learn-epic-failure-google-flu-trends/) použil dátovú vedu na koreláciu vyhľadávacích výrazov s trendmi chrípky. Hoci prístup mal nedostatky, zvýšil povedomie o možnostiach (a výzvách) predpovedí zdravotnej starostlivosti založených na dátach.

 * [Predikcie trás UPS](https://www.technologyreview.com/2018/11/21/139000/how-ups-uses-ai-to-outsmart-bad-weather/) - vysvetľuje, ako UPS využíva dátovú vedu a strojové učenie na predpovedanie optimálnych trás pre doručovanie, pričom berie do úvahy poveternostné podmienky, dopravné vzory, termíny doručenia a ďalšie faktory.
...
Obrázok ukazuje ďalšie oblasti a príklady aplikácie techník dátovej vedy. Chcete preskúmať ďalšie aplikácie? Pozrite si sekciu [Review & Self Study](../../../../6-Data-Science-In-Wild/20-Real-World-Examples) nižšie.
...
Pre študentov môžu tieto výskumné projekty poskytnúť príležitosti na učenie a spoluprácu, ktoré môžu zlepšiť vaše pochopenie témy a rozšíriť vaše povedomie a zapojenie sa s relevantnými ľuďmi alebo tímami pracujúcimi v oblastiach záujmu. Ako teda vyzerajú výskumné projekty a aký môžu mať dopad?
 ...
 * **Čo:** Cieľom výskumného projektu bolo _vyhodnotiť predsudky prítomné v automatizovaných algoritmoch a dátových súboroch na analýzu tváre_ na základe pohlavia a typu pokožky. 
 ...
 * [Hub](https://planetarycomputer.microsoft.com/docs/overview/environment/) - spravované prostredie
