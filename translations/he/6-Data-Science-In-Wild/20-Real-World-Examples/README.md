...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T20:15:59+00:00",
...
[שאלון לפני השיעור](https://ff-quizzes.netlify.app/en/ds/)

## מדע הנתונים + תעשייה

בזכות הדמוקרטיזציה של הבינה המלאכותית, מפתחים מוצאים כיום קל יותר לעצב ולשלב תובנות מבוססות נתונים וקבלת החלטות מונעת AI בחוויות משתמש ובתהליכי פיתוח. הנה כמה דוגמאות כיצד מדע הנתונים "מיושם" ביישומים בעולם האמיתי בתעשייה:
 ...
 * [UPS Routing Predictions](https://www.technologyreview.com/2018/11/21/139000/how-ups-uses-ai-to-outsmart-bad-weather/) - מסביר כיצד UPS משתמשת במדע הנתונים ולמידת מכונה כדי לחזות מסלולים אופטימליים למשלוח, תוך התחשבות בתנאי מזג אוויר, דפוסי תנועה, מועדי אספקה ועוד.

 * [NYC Taxicab Route Visualization](http://chriswhong.github.io/nyctaxi/) - נתונים שנאספו באמצעות [חוקי חופש המידע](https://chriswhong.com/open-data/foil_nyc_taxi/) עזרו להמחיש יום בחיי המוניות בניו יורק, ולעזור לנו להבין כיצד הן מנווטות בעיר העמוסה, הכסף שהן מרוויחות, ומשך הנסיעות בכל תקופה של 24 שעות.

 * [Uber Data Science Workbench](https://eng.uber.com/dsw/) - משתמש בנתונים (על מיקומי איסוף והורדה, משך נסיעה, מסלולים מועדפים וכו') שנאספו ממיליוני נסיעות יומיות באובר כדי לבנות כלי ניתוח נתונים המסייע בתמחור, בטיחות, זיהוי הונאות והחלטות ניווט.
 ...
 * [מדע הנתונים בבריאות](https://data-flair.training/blogs/data-science-in-healthcare/) - מדגיש יישומים כמו הדמיה רפואית (למשל, MRI, רנטגן, CT-Scan), גנומיקה (ריצוף DNA), פיתוח תרופות (הערכת סיכונים, תחזית הצלחה), אנליטיקה חזויה (טיפול בחולים ולוגיסטיקה של אספקה), מעקב ומניעת מחלות ועוד.
 ...
 * **למה:** ניתוח פנים משמש בתחומים כמו אכיפת חוק, אבטחת שדות תעופה, מערכות גיוס ועוד - הקשרים שבהם סיווגים שגויים (למשל, עקב הטיה) יכולים לגרום לנזקים כלכליים וחברתיים פוטנציאליים לפרטים או קבוצות מושפעות. הבנת הטיות (והסרתן או הפחתתן) היא מפתח להוגנות בשימוש.
...
התוצאות הראו שלמרות שהדיוק הכולל בסיווג היה טוב, הייתה הבחנה ברורה בשיעורי השגיאות בין קבוצות שונות - עם **שגיאות זיהוי מגדר** גבוהות יותר לנשים או אנשים בעלי עור כהה, מה שמעיד על הטיה.

**תוצאות מרכזיות:** העלאת מודעות לכך שמדע הנתונים זקוק ל_מאגרי נתונים ייצוגיים יותר_ (קבוצות מאוזנות) ול_צוותים מגוונים יותר_ (רקע מגוון) כדי לזהות ולהסיר או להפחית הטיות כאלה מוקדם יותר בפתרונות AI. מאמצי מחקר כמו זה גם תורמים לכך שארגונים רבים מגדירים עקרונות ופרקטיקות ל_בינה מלאכותית אחראית_ לשיפור ההוגנות במוצרים ובתהליכים שלהם.

**רוצים ללמוד על מאמצי מחקר רלוונטיים ב-Microsoft?**

* בדקו [פרויקטי מחקר של Microsoft](https://www.microsoft.com/research/research-area/artificial-intelligence/?facet%5Btax%5D%5Bmsr-research-area%5D%5B%5D=13556&facet%5Btax%5D%5Bmsr-content-type%5D%5B%5D=msr-project) בתחום הבינה המלאכותית.
...
* בדקו את פרויקט [Fairlearn](https://fairlearn.org/) ואת יוזמות [בינה מלאכותית אחראית](https://www.microsoft.com/en-us/ai/responsible-ai?activetab=pivot1%3aprimaryr6).
 ...
 * [`ניתוח רגשות`](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671#sentiment-analysis-using-cognitive-services) - מסביר כיצד ניתן לשלב שירותי ענן כמו Text Analytics, באמצעות כלים עם קוד נמוך כמו [Power Automate](https://flow.microsoft.com/en-us/) לעיבוד נתונים אוטומטי.
...
* [בקשו גישה](https://planetarycomputer.microsoft.com/account/request) כדי להתחיל לחקור ולהתחבר עם עמיתים.
...
דיברנו על יישומים בעולם האמיתי בתעשייה ובמחקר, וחקרנו דוגמאות ליישומי מדעי הנתונים במדעי הרוח הדיגיטליים ובקיימות. אז איך תוכלו לפתח את הכישורים שלכם ולשתף את המומחיות שלכם כמתחילים במדעי הנתונים?
...
## [חידון לאחר ההרצאה](https://ff-quizzes.netlify.app/en/ds/)
 ...
 * מדעי הנתונים ב: [חינוך](https://data-flair.training/blogs/data-science-in-education/), [חקלאות](https://data-flair.training/blogs/data-science-in-agriculture/), [פיננסים](https://data-flair.training/blogs/data-science-in-finance/), [סרטים](https://data-flair.training/blogs/data-science-at-movies/) ועוד.
