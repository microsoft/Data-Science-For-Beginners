...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T14:16:22+00:00",
...
Azure Cloud Advocates במיקרוסופט שמחים להציע תוכנית לימודים בת 10 שבועות ו-20 שיעורים בנושא מדעי הנתונים. כל שיעור כולל מבחנים לפני ואחרי השיעור, הוראות כתובות להשלמת השיעור, פתרון ומשימה. הגישה שלנו מבוססת פרויקטים ומאפשרת ללמוד תוך כדי בנייה, שיטה מוכחת להטמעת מיומנויות חדשות.
...
- [עמוד מרכז הסטודנטים](https://docs.microsoft.com/en-gb/learn/student-hub?WT.mc_id=academic-77958-bethanycheum) בעמוד זה תמצאו משאבים למתחילים, חבילות לסטודנטים ואפילו דרכים לקבל שובר הסמכה בחינם. זהו עמוד שכדאי לסמן ולבדוק מדי פעם, שכן אנו מעדכנים את התוכן לפחות פעם בחודש.
...
## 👨‍🎓 לסטודנטים
> **מתחילים מוחלטים**: חדשים במדעי הנתונים? התחילו עם [דוגמאות ידידותיות למתחילים](examples/README.md)! דוגמאות פשוטות ומוסברות היטב אלו יעזרו לכם להבין את היסודות לפני שתצללו לתוכנית הלימודים המלאה.
...
3. התחילו בשיעור הראשון ועבדו לפי הסדר
...
בחרנו שני עקרונות פדגוגיים בעת בניית תוכנית הלימודים הזו: להבטיח שהיא מבוססת פרויקטים ושכוללת מבחנים תכופים. בסוף הסדרה, סטודנטים ילמדו עקרונות בסיסיים של מדעי הנתונים, כולל מושגים אתיים, הכנת נתונים, דרכים שונות לעבודה עם נתונים, ויזואליזציה של נתונים, ניתוח נתונים, שימושים אמיתיים במדעי הנתונים ועוד.
בנוסף, מבחן קצר לפני השיעור יכול לעזור לתלמיד להתמקד בלמידת הנושא, בעוד שמבחן נוסף לאחר השיעור מסייע לשימור הידע. תכנית הלימודים הזו עוצבה להיות גמישה ומהנה, וניתן ללמוד אותה במלואה או בחלקים. הפרויקטים מתחילים קטנים והופכים מורכבים יותר לקראת סוף מחזור של 10 שבועות.
...
> **הערה לגבי מבחנים**: כל המבחנים נמצאים בתיקיית Quiz-App, סך הכל 40 מבחנים עם שלוש שאלות כל אחד. הם מקושרים מתוך השיעורים, אך ניתן להריץ את אפליקציית המבחנים באופן מקומי או לפרוס אותה ב-Azure; עקבו אחר ההוראות בתיקיית `quiz-app`. המבחנים מתורגמים בהדרגה.
...
|![ איור סקיצה מאת @sketchthedocs https://sketchthedocs.dev](../../translated_images/00-Roadmap.4905d6567dff47532b9bfb8e0b8980fc6b0b1292eebb24181c1a9753b33bc0f5.he.png)|
|:---:|
| מדעי הנתונים למתחילים: מפת דרכים - _איור סקיצה מאת [@nitya](https://twitter.com/nitya)_ |
...
1. אם זו הפעם הראשונה שאתם משתמשים במיכל פיתוח, ודאו שמערכתכם עומדת בדרישות המקדימות (למשל, התקנת Docker) ב-[תיעוד ההתחלה](https://code.visualstudio.com/docs/devcontainers/containers#_getting-started).

כדי להשתמש במאגר זה, תוכלו לפתוח את המאגר בנפח Docker מבודד:

**הערה**: מאחורי הקלעים, פעולה זו תשתמש בפקודה Remote-Containers: **Clone Repository in Container Volume...** כדי לשכפל את קוד המקור בנפח Docker במקום במערכת הקבצים המקומית. [נפחים](https://docs.docker.com/storage/volumes/) הם המנגנון המועדף לשימור נתוני מיכלים.
...
- בחרו את העותק המשוכפל של תיקייה זו, המתינו עד שהמיכל יתחיל, ונסו את הדברים.
...
- [AI גנרטיבי למתחילים](https://aka.ms/genai-beginners)
- [AI גנרטיבי למתחילים .NET](https://github.com/microsoft/Generative-AI-for-beginners-dotnet)
- [AI גנרטיבי עם JavaScript](https://github.com/microsoft/generative-ai-with-javascript)
- [AI גנרטיבי עם Java](https://aka.ms/genaijava)
...
**נתקלתם בבעיות?** עיינו ב-[מדריך פתרון הבעיות](TROUBLESHOOTING.md) למציאת פתרונות לבעיות נפוצות.  

אם אתם נתקעים או יש לכם שאלות לגבי בניית אפליקציות AI, הצטרפו:  

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)  

אם יש לכם משוב על המוצר או נתקלתם בשגיאות במהלך הבנייה, בקרו:  
