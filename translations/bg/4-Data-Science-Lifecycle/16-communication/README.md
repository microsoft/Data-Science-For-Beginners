...
|:---:|
| Жизнен цикъл на науката за данни: Комуникация - _Скетч от [@nitya](https://twitter.com/nitya)_ |
...
Можете вероятно да групирате по-голямата част от вашата аудитория в категория. В статия на _Harvard Business Review_, “[Как да разкажем история с данни](http://blogs.hbr.org/2013/04/how-to-tell-a-story-with-data/)”, стратегът на Dell Джим Стайкълтър идентифицира пет категории аудитории:
...
**Решение 1.** Наемане на служители за обслуж
