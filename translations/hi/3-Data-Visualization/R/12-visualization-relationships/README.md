...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-24T01:14:29+00:00",
...
इस पाठ में, आप ggplot2 का उपयोग कर सकते हैं, जिसे आपने पहले भी उपयोग किया है। यह लाइब्रेरी चर के बीच संबंधों को चित्रित करने के लिए बहुत उपयोगी है। विशेष रूप से ggplot2 के `geom_point` और `qplot` फ़ंक्शन का उपयोग दिलचस्प है, जो स्कैटर प्लॉट्स और लाइन प्लॉट्स को जल्दी से '[सांख्यिकीय संबंधों](https://ggplot2.tidyverse.org/)' को दिखाने की अनुमति देता है। यह डेटा वैज्ञानिक को यह समझने में मदद करता है कि चर एक-दूसरे से कैसे संबंधित हैं।

## स्कैटरप्लॉट्स

स्कैटरप्लॉट का उपयोग करके दिखाएं कि शहद की कीमत साल दर साल, प्रति राज्य कैसे विकसित हुई है। ggplot2, `ggplot` और `geom_point` का उपयोग करते हुए, राज्य डेटा को आसानी से समूहित करता है और श्रेणीबद्ध और संख्यात्मक डेटा दोनों के लिए डेटा पॉइंट्स प्रदर्शित करता है। 
...
एक बेसिक स्कैटरप्लॉट बनाएं, जो शहद की प्रति पाउंड कीमत और उसके अमेरिकी राज्य के मूल के बीच संबंध दिखाए। `y` अक्ष को इतना लंबा बनाएं कि सभी राज्यों को प्रदर्शित किया जा सके:
...
```
![स्कैटरप्लॉट 1](../../../../../3-Data-Visualization/R/12-visualization-relationships/images/scatter1.png)

अब, वही डेटा एक शहद रंग योजना के साथ दिखाएं, ताकि यह दिखाया जा सके कि कीमत वर्षों में कैसे विकसित हुई। आप इसे 'scale_color_gradientn' पैरामीटर जोड़कर कर सकते हैं, जो साल दर साल परिवर्तन दिखाता है:
...
एक और तरीका यह है कि रंग के बजाय आकार का उपयोग करें। रंग-अंधता वाले उपयोगकर्ताओं के लिए, यह एक बेहतर विकल्प हो सकता है। अपने विज़ुअलाइज़ेशन को संपादित करें ताकि कीमत में वृद्धि को डॉट के परिधि में वृद्धि के रूप में दिखाया जा सके:
...
![स्कैटरप्लॉट 3](../../../../../3-Data-Visualization/R/12-visualization-relationships/images/scatter3.png)
...
![लाइन चार्ट 1](../../../../../3-Data-Visualization/R/12-visualization-relationships/images/line1.png)
...
![लाइन चार्ट 2](../../../../../3-Data-Visualization/R/12-visualization-relationships/images/line2.png)

उत्तर: वास्तव में नहीं। यदि आप कुल उत्पादन को देखें, तो ऐसा लगता है कि यह विशेष वर्ष में बढ़ा है, हालांकि सामान्य रूप से इन वर्षों के दौरान उत्पादित शहद की मात्रा में गिरावट हो रही है।
...
फेसट ग्रिड्स आपके डेटा सेट के एक पहलू (हमारे मामले में, आप 'वर्ष' चुन सकते हैं ताकि बहुत अधिक ग्रिड्स न बनें) को लेते हैं। Seaborn तब आपके चुने गए x और y निर्देशांक के लिए प्रत्येक पहलू का एक प्लॉट बना सकता है, जिससे तुलना करना आसान हो जाता है। क्या 2003 इस प्रकार की तुलना में अलग दिखता है?
...
![फेसट ग्रिड](../../../../../3-Data-Visualization/R/12-visualization-relationships/images/facet.png)
...
R के `par` और `plot` फ़ंक्शन का उपयोग करके दो लाइनप्लॉट्स को एक-दूसरे के ऊपर सुपरइम्पोज़ करके एक मल्टीलाइन प्लॉट आज़माएं। हम x अक्ष पर वर्ष को प्लॉट करेंगे और दो y अक्ष प्रदर्शित करेंगे। तो, कॉलोनी की प्रति कॉलोनी उपज और कॉलोनियों की संख्या को सुपरइम्पोज़ करें:
...
```
![सुपरइम्पोज़्ड प्लॉट्स](../../../../../3-Data-Visualization/R/12-visualization-relationships/images/dual-line.png)

हालांकि 2003 के आसपास कुछ भी स्पष्ट रूप से नहीं दिखता, यह हमें इस पाठ को एक खुशहाल नोट पर समाप्त करने की अनुमति देता है: जबकि कुल मिलाकर कॉलोनियों की संख्या में गिरावट हो रही है, कॉलोनियों की संख्या स्थिर हो रही है, भले ही उनकी प्रति कॉलोनी उपज घट रही हो।
...
लाइन प्लॉट्स सरल या काफी जटिल हो सकते हैं। [ggplot2 दस्तावेज़](https://ggplot2.tidyverse.org/reference/geom_path.html#:~:text=geom_line()%20connects%20them%20in,which%20cases%20are%20connected%20together) में विभिन्न तरीकों पर थोड़ा पढ़ें, जिनसे आप उन्हें बना सकते हैं। इस पाठ में आपने जो लाइन चार्ट्स बनाए हैं, उन्हें दस्तावेज़ में सूचीबद्ध अन्य तरीकों से बढ़ाने का प्रयास करें।
## असाइनमेंट
