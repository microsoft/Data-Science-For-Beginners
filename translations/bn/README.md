...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:29:50+00:00",
  "source_file": "README.md",
  "language_code": "bn"
}
-->
# ডেটা সায়েন্সের জন্য শিক্ষার্থীদের জন্য - একটি পাঠ্যক্রম
...
3. প্রথম পাঠ দিয়ে শুরু করুন এবং ক্রমান্বয়ে এগিয়ে যান
...
| 12 | সম্পর্ক ভিজ্যুয়ালাইজ করা | [ডেটা ভিজ্যুয়ালাইজেশন](3-Data-Visualization/README.md) | ডেটার সেট এবং এর ভেরিয়েবলগুলির মধ্যে সংযোগ এবং সম্পর্ক ভিজ্যুয়ালাইজ করা। | [পাঠ](3-Data-Visualization/12-visualization-relationships/README.md) | [Jen](https://twitter.com/jenlooper) |
