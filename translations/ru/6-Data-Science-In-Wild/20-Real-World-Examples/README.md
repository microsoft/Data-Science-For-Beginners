...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T15:38:14+00:00",
...
В этом уроке мы исследуем реальные применения Data Science в различных отраслях и углубимся в конкретные примеры в области исследований, цифровых гуманитарных наук и устойчивого развития. Мы рассмотрим возможности студенческих проектов и завершим полезными ресурсами, которые помогут вам продолжить обучение!

## Предварительный тест

[Предварительный тест](https://ff-quizzes.netlify.app/en/ds/)

## Data Science + Индустрия

Благодаря демократизации ИИ разработчикам стало проще проектировать и интегрировать решения на основе ИИ и инсайты, основанные на данных, в пользовательский опыт и рабочие процессы разработки. Вот несколько примеров того, как Data Science применяется в реальных условиях в различных отраслях:

 * [Google Flu Trends](https://www.wired.com/2015/10/can-learn-epic-failure-google-flu-trends/) использовал Data Science для корреляции поисковых запросов с тенденциями распространения гриппа. Хотя подход имел недостатки, он привлек внимание к возможностям (и вызовам) прогнозирования в здравоохранении на основе данных.
 ...
 * [Визуализация маршрутов такси в Нью-Йорке](http://chriswhong.github.io/nyctaxi/) - данные, собранные с использованием [Законов о свободе информации](https://chriswhong.com/open-data/foil_nyc_taxi/), помогли визуализировать день из жизни такси Нью-Йорка, что позволило понять, как они передвигаются по городу, сколько зарабатывают и какова продолжительность поездок в течение 24 часов.

 * [Рабочая платформа Data Science от Uber](https://eng.uber.com/dsw/) - использует данные (о местах посадки и высадки, продолжительности поездок, предпочтительных маршрутах и т.д.), собранные с миллионов поездок Uber ежедневно, для создания аналитического инструмента, который помогает в ценообразовании, обеспечении безопасности, обнаружении мошенничества и принятии навигационных решений.

 * [Аналитика в спорте](https://towardsdatascience.com/scope-of-analytics-in-sports-world-37ed09c39860) - включает _предиктивную аналитику_ (анализ команд и игроков - вспомните [Moneyball](https://datasciencedegree.wisconsin.edu/blog/moneyball-proves-importance-big-data-big-ideas/) - и управление фанатами) и _визуализацию данных_ (дашборды команд и фанатов, игры и т.д.) с такими приложениями, как поиск талантов, спортивные ставки и управление инвентарем/местами проведения.

 * [Data Science в банковской сфере](https://data-flair.training/blogs/data-science-in-banking/) - подчеркивает ценность Data Science в финансовой отрасли с такими приложениями, как моделирование рисков, обнаружение мошенничества, сегментация клиентов, прогнозирование в реальном времени и рекомендательные системы. Предиктивная аналитика также лежит в основе таких критически важных показателей, как [кредитные рейтинги](https://dzone.com/articles/using-big-data-and-predictive-analytics-for-credit).
...
![Применение Data Science в реальном мире](../../../../translated_images/data-science-applications.4e5019cd8790ebac2277ff5f08af386f8727cac5d30f77727c7090677e6adb9c.ru.png) Источник изображения: [Data Flair: 6 Amazing Data Science Applications ](https://data-flair.training/blogs/data-science-applications/)
...
* _вызовы внедрения_ - изучение потенциальных вредных последствий или непредвиденных эффектов технологий Data Science в реальных условиях.
 ...
 * **Что:** Целью проекта было _оценить предвзятость в алгоритмах и наборах данных для автоматического анализа лиц_ на основе пола и типа кожи.
...
* Изучите студенческие проекты из [Летней школы Data Science Microsoft Research](https://www.microsoft.com/en-us/research/academic-program/data-science-summer-school/).
...
Ознакомьтесь с ["Эмили Дикинсон и метром настроения"](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671) - отличным примером от [Джен Лупер](https://twitter.com/jenlooper), который задается вопросом, как мы можем использовать Data Science, чтобы переосмыслить знакомую поэзию и переоценить ее значение и вклад автора в новых контекстах. Например, _можем ли мы предсказать сезон, в который было написано стихотворение, анализируя его тон или настроение_ - и что это говорит нам о состоянии автора в соответствующий период?

Чтобы ответить на этот вопрос, мы следуем этапам жизненного цикла Data Science:
...
Используя этот рабочий процесс, мы можем исследовать сезонные влияния на настроение стихотворений и помочь нам сформировать собственные взгляды на автора. Попробуйте сами - затем расширьте ноутбук, чтобы задать другие вопросы или визуализировать данные по-новому!

> Вы можете использовать некоторые инструменты из [набор инструментов цифровых гуманитарных наук](https://github.com/Digital-Humanities-Toolkit), чтобы продолжить исследования в этом направлении.
...
Решение этих задач в масштабах и в сжатые сроки требует облачного подхода и работы с большими объемами данных. Инициатива [Planetary Computer](https://planetarycomputer.microsoft.com/) предоставляет 4 компонента, которые помогут специалистам по данным и разработчикам в этом направлении:
...
Мы обсудили реальные приложения в индустрии и исследованиях, а также рассмотрели примеры использования анализа данных в цифровых гуманитарных науках и устойчивом развитии. Так как же вы можете развивать свои навыки и делиться своим опытом, будучи начинающими специалистами в области анализа данных?

Вот несколько примеров студенческих проектов по анализу данных, которые могут вас вдохновить:
 ...
 * Анализ данных в: [образовании](https://data-flair.training/blogs/data-science-in-education/), [сельском хозяйстве](https://data-flair.training/blogs/data-science-in-agriculture/), [финансах](https://data-flair.training/blogs/data-science-in-finance/), [киноиндустрии](https://data-flair.training/blogs/data-science-at-movies/) и других областях.
