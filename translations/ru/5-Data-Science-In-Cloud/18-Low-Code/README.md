...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T15:25:16+00:00",
...
Azure ML предоставляет все необходимые инструменты для разработчиков и дата-сайентистов, включая:
...
|                   | Без кода/Минимальный код | Azure ML SDK              |
|-------------------|--------------------------|---------------------------|
