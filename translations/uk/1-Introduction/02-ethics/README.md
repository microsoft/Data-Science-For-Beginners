...
Давайте коротко розглянемо ці принципи. _Прозорість_ і _відповідальність_ є основними цінностями, на яких будуються інші принципи, тому почнемо з них:
...
Після того, як ми визначили етичні принципи, наступним кроком є оцінка наших дій з даними та AI, щоб переконатися, що вони відповідають цим спільним цінностям. Подумайте про свої дії у двох категоріях: _збір даних_ та _розробка алгоритмів_.
