...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T22:39:23+00:00",
...
![Графічне представлення сховища даних типу ключ-значення, що показує 4 унікальні числові ключі, пов’язані з 4 різними значеннями](../../../../2-Working-With-Data/06-non-relational/images/kv-db.png)
> Джерело: [Блог Michał Białecki](https://www.michalbialecki.com/2018/03/18/azure-cosmos-db-key-value-database-cloud/)

[Ключ-значення](https://docs.microsoft.com/en-us/azure/architecture/data-guide/big-data/non-relational-data#keyvalue-data-stores) бази даних поєднують унікальні ключі, які є унікальними ідентифікаторами, пов’язаними зі значенням. Ці пари зберігаються за допомогою [хеш-таблиці](https://www.hackerearth.com/practice/data-structures/hash-tables/basics-of-hash-tables/tutorial/) із відповідною хеш-функцією.
...
![Графічне представлення колонкової бази даних, що показує базу даних клієнтів із двома сімействами колонок: Identity і Contact Info](../../../../2-Working-With-Data/06-non-relational/images/columnar-db.png)

[Колонкові](https://docs.microsoft.com/en-us/azure/architecture/data-guide/big-data/non-relational-data#columnar-data-stores) сховища даних організовують дані в стовпці та рядки, як реляційна структура даних, але кожен стовпець розділений на групи, які називаються сімействами колонок, де всі дані під одним стовпцем пов’язані та можуть бути отримані або змінені як одна одиниця.
...
#### Запити до документних даних за допомогою емулятора Cosmos DB
...
![Виконання SELECT-запиту до зразкових даних у емуляторі Cosmos DB для пошуку документів, у яких значення поля age менше 40](../../../../2-Working-With-Data/06-non-relational/images/cosmosdb-emulator-persons-query.png)
