...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T22:44:07+00:00",
...
Ми розуміємо, що мета комунікації – передавати або обмінюватися інформацією. Але коли йдеться про комунікацію даних, ваша мета не повинна полягати лише в передачі чисел вашій аудиторії. Ваша мета – передати історію, яка базується на ваших даних. Ефективна комунікація даних та розповідання історій йдуть рука об руку. Аудиторія з більшою ймовірністю запам'ятає історію, яку ви розповіли, ніж просто цифри, які ви надали. Пізніше в цьому уроці ми розглянемо кілька способів, як можна використовувати розповідання історій для більш ефективної комунікації даних.
...
### 1. Зрозумійте свою аудиторію, канал та метод комунікації
Спосіб, яким ви спілкуєтеся з членами сім’ї, ймовірно, відрізняється від того, як ви спілкуєтеся з друзями. Ви, мабуть, використовуєте різні слова та фрази, які люди, з якими ви розмовляєте, швидше зрозуміють. Ви повинні застосовувати такий самий підхід, коли комунікуєте дані. Подумайте, з ким ви спілкуєтеся. Подумайте про їхні цілі та контекст, який вони мають щодо ситуації, яку ви їм пояснюєте.
...
- **Загальний слухач**: обізнаний із темою, але шукає оглядове розуміння та основні теми
...
Крім розуміння вашої аудиторії, важливо також знати, як ви будете спілкуватися з нею (використовуючи односторонню чи двосторонню комунікацію).

Якщо ви спілкуєтеся з аудиторією, яка переважно складається з новачків, і використовуєте односторонню комунікацію, вам спочатку потрібно навчити аудиторію та надати їй належний контекст. Потім ви повинні представити їм свої дані, пояснити їх значення та чому вони важливі. У цьому випадку вам слід зосередитися на забезпеченні ясності, оскільки ваша аудиторія не зможе поставити вам прямі запитання.

Якщо ви спілкуєтеся з аудиторією, яка переважно складається з менеджерів, і використовуєте двосторонню комунікацію, вам, ймовірно, не потрібно буде навчати аудиторію або надавати їй багато контексту. Ви можете одразу перейти до обговорення зібраних вами даних і їх значення. У цьому сценарії вам слід зосередитися на таймінгу та контролі вашої презентації. Під час двосторонньої комунікації (особливо з аудиторією менеджерів, які прагнуть «практичного розуміння складнощів і взаємозв’язків із доступом до деталей») під час вашої взаємодії можуть виникати запитання, які можуть відвести обговорення в напрямок, що не стосується історії, яку ви намагаєтеся розповісти. У таких випадках ви можете вжити заходів, щоб повернути обговорення на правильний шлях.

### 2. Починайте з кінцевої мети
Починати з кінцевої мети означає розуміти, які висновки ви хочете, щоб ваша аудиторія зробила, ще до того, як ви почнете комунікувати з нею. Обдумування того, що ви хочете, щоб ваша аудиторія винесла, заздалегідь може допомогти вам створити історію, яку ваша аудиторія зможе зрозуміти. Починати з кінцевої мети доречно як для односторонньої, так і для двосторонньої комунікації.
...
Якщо всі дані, які ви зібрали, чітко підтримують ваші висновки – чудово. Але якщо є дані, які не підтримують ваші висновки або навіть підтримують аргумент проти ваших ключових висновків, ви повинні комунікувати ці дані також. У таких випадках будьте чесними з вашою аудиторією та поясніть, чому ви вирішили дотримуватися своєї історії, навіть якщо всі дані її не підтримують.

### 3. Підходьте до цього як до справжньої історії
Традиційна історія складається з 5 фаз. Ви могли чути ці фази як Експозиція, Наростання дії, Кульмінація, Спадання дії та Розв’язка. Або більш простий варіант: Контекст, Конфлікт, Кульмінація, Закриття, Висновок. Коли ви комунікуєте ваші дані та вашу історію, ви можете використовувати схожий підхід.
...
### 4. Використовуйте значущі слова та фрази
Якщо ми з вами працювали б над продуктом, і я сказав би вам: "Наші користувачі витрачають багато часу на реєстрацію на нашій платформі," скільки часу ви б оцінили як "багато"? Годину? Тиждень? Важко сказати. А що, якби я сказав це цілій аудиторії? Кожен у аудиторії міг би мати різне уявлення про те, скільки часу займає реєстрація на нашій платформі.

Натомість, що якби я сказав: "Наші користувачі витрачають у середньому 3 хвилини на реєстрацію та початок роботи на нашій платформі."

Таке повідомлення є більш зрозумілим. Коли ви комунікуєте дані, легко припустити, що всі у вашій аудиторії думають так само, як і ви. Але це не завжди так. Забезпечення ясності щодо ваших даних та їх значення – одна з ваших відповідальностей як комунікатора. Якщо дані або ваша історія не зрозумілі, вашій аудиторії буде важко слідувати за вами, і менш ймовірно, що вона зрозуміє ваші ключові висновки.
...
- Ця задача потребуватиме *значних* зусиль.
...
Ви могли зустрічати це раніше в телевізійних рекламних роликах. Деякі ролики дуже сумні та використовують емоцію смутку, щоб зв’язатися з аудиторією та зробити представлені дані більш помітними. Або ж деякі ролики дуже життєрадісні та щасливі, що може змусити вас асоціювати їхні дані з позитивними емоціями.

Як використовувати емоції при комунікації даних? Нижче наведено кілька способів.

- Використовуйте відгуки та особисті історії
	- Під час збору даних намагайтеся збирати як кількісні, так і якісні дані, і інтегруйте обидва типи даних у вашу комунікацію. Якщо ваші дані переважно кількісні, шукайте історії від окремих осіб, щоб дізнатися більше про їхній досвід, пов’язаний із вашими даними.
...
- Використовуйте кольори
	- Різні кольори викликають різні емоції. Популярні кольори та емоції, які вони викликають, наведені нижче. Будьте уважні, оскільки кольори можуть мати різні значення в різних культурах.
		- Синій зазвичай викликає емоції миру та довіри
		- Зелений зазвичай асоціюється з природою та навколишнім середовищем
		- Червоний зазвичай означає пристрасть та збудження
		- Жовтий зазвичай асоціюється з оптимізмом та щастям

# Випадок комунікації
Емерсон – менеджер продукту мобільного додатку. Емерсон помітив, що клієнти подають на 42% більше скарг і повідомлень про помилки у вихідні дні
На зустрічі Емерсон витратив 5 хвилин, пояснюючи, чому низький рейтинг у магазині додатків є проблемою, 10 хвилин на пояснення процесу дослідження та як були визначені тенденції, 10 хвилин на розгляд деяких останніх скарг клієнтів, і останні 5 хвилин поверхнево торкнувся двох потенційних рішень.

Чи був це ефективний спосіб комунікації для Емерсона під час цієї зустрічі?

Під час зустрічі один із керівників компанії зосередився на 10 хвилинах скарг клієнтів, які Емерсон розглянув. Після зустрічі ці скарги були єдиним, що цей керівник запам’ятав. Інший керівник компанії здебільшого звернув увагу на опис процесу дослідження Емерсоном. Третій керівник компанії запам’ятав запропоновані Емерсоном рішення, але не був впевнений, як ці рішення можна реалізувати.
...
Це можна викласти так: "На даний момент рейтинг нашого додатку в магазині становить 2.5. Рейтинги в магазині додатків є критичними для оптимізації в магазині додатків, що впливає на те, скільки користувачів бачать наш додаток у пошуку, і як наш додаток сприймається потенційними користувачами. І, звісно, кількість наших користувачів безпосередньо пов’язана з доходом."

**Конфлікт** Емерсон міг би перейти до обговорення конфлікту протягом наступних 5 хвилин.

Це могло б звучати так: "Користувачі подають на 42% більше скарг і звітів про помилки у вихідні дні. Клієнти, які подають скаргу, що залишається без відповіді протягом 48 годин, на 32% менш схильні поставити нашому додатку рейтинг вище 2 у магазині додатків. Покращення рейтингу нашого додатку в магазині до 4 підвищило б нашу видимість на 20-30%, що, за моїми прогнозами, збільшило б дохід на 10%." Звісно, Емерсон має бути готовий обґрунтувати ці цифри.

**Кульмінація** Після закладення основи Емерсон міг би перейти до кульмінації на наступні 5 хвилин.

Емерсон міг би представити запропоновані рішення, пояснити, як ці рішення вирішать окреслені проблеми, як їх можна інтегрувати в існуючі робочі процеси, скільки вони коштують, який буде їхній ROI, і навіть показати скріншоти або макети того, як ці рішення виглядатимуть після впровадження. Емерсон також міг би поділитися відгуками користувачів, які чекали понад 48 годин на вирішення своєї скарги, а також відгуком від поточного представника служби підтримки клієнтів компанії, який має коментарі щодо існуючої системи обробки заявок.
...
Перевірте, що ви щойно вивчили, за допомогою тесту після лекції за посиланням вище!  

## Завдання  

[Маркетингове дослідження](assignment.md)  
