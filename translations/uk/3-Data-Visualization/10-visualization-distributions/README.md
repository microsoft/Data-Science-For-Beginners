...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T22:47:29+00:00",
...
Ще один спосіб аналізу даних — це вивчення їх розподілу, тобто того, як дані організовані вздовж осі. Наприклад, можливо, ви хочете дізнатися про загальний розподіл максимального розмаху крил або максимальної маси тіла птахів Міннесоти в цьому наборі даних.
...
Це дає загальний огляд розподілу довжини тіла за рядом птахів, але це не найкращий спосіб відображення справжніх розподілів. Для цього зазвичай використовують гістограми.

## Робота з гістограмами

Matplotlib пропонує чудові способи візуалізації розподілу даних за допомогою гістограм. Цей тип графіка схожий на стовпчастий графік, де розподіл можна побачити через підйом і спад стовпців. Для створення гістограми потрібні числові дані. Щоб побудувати гістограму, ви можете створити графік, визначивши тип як 'hist' для гістограми. Цей графік показує розподіл MaxBodyMass для всього діапазону числових даних набору. Розділяючи масив даних на менші групи, він може показати розподіл значень даних:
...
Цей графік показує розподіл трохи більш детально. Менш зміщений графік можна створити, вибравши дані лише в заданому діапазоні:
...
Гістограма пропонує також цікаві можливості для кольорових і текстових покращень.
...
![2D графік](../../../../3-Data-Visualization/10-visualization-distributions/images/2D-wb.png)
...
Цей набір даних також містить корисну інформацію про категорію птахів, їх рід, вид і родину, а також статус збереження. Давайте розглянемо інформацію про статус збереження. Який розподіл птахів за їх статусом збереження?
...
Якщо ви хотіли б повернутися до тієї нерівної лінії MaxBodyMass на другому графіку, який ви створили, ви могли б дуже добре її згладити, відтворивши її за допомогою цього методу:
...
Якщо ви хочете отримати гладку, але не надто гладку лінію, змініть параметр `bw_adjust`: 
...
![маса тіла за рядом](../../../../3-Data-Visualization/10-visualization-distributions/images/density4.png)

Ви також можете відобразити щільність кількох змінних на одному графіку. Порівняйте MaxLength і MinLength птаха зі статусом його збереження:
...
У цьому уроці ви використовували Matplotlib і почали працювати з Seaborn, щоб створювати більш складні графіки. Проведіть дослідження про `kdeplot` у Seaborn, "неперервну криву щільності ймовірності в одному або кількох вимірах". Ознайомтеся з [документацією](https://seaborn.pydata.org/generated/seaborn.kdeplot.html), щоб зрозуміти, як це працює.
