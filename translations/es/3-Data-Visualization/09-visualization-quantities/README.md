...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-24T01:27:17+00:00",
...
✅ Hay muy buenas 'chuletas' disponibles para Matplotlib [aquí](https://matplotlib.org/cheatsheets/cheatsheets.pdf).
...
|      | Nombre                        | NombreCientífico       | Categoría             | Orden        | Familia  | Género      | EstadoConservación | LongMin | LongMax | PesoMin | PesoMax | EnvergaduraMin | EnvergaduraMax |
| ---: | :---------------------------- | :--------------------- | :-------------------- | :----------- | :------- | :---------- | :----------------- | -------: | -------: | -------: | -------: | --------------: | --------------: |
...
|    1 | Pato silbador canela          | Dendrocygna bicolor    | Patos/Gansos/Acuáticas| Anseriformes | Anatidae | Dendrocygna | LC                 |       45 |       53 |      712 |     1050 |              85 |              93 |
...
|    4 | Ganso careto                  | Anser albifrons        | Patos/Gansos/Acuáticas| Anseriformes | Anatidae | Anser       | LC                 |       64 |       81 |     1930 |     3310 |             130 |             165 |
...
plt.show()
```  
¿Qué está pasando aquí? Usaste `tick_params` para ocultar las etiquetas inferiores y luego creaste un bucle sobre tu conjunto de datos de aves. Al graficar el gráfico con pequeños puntos azules redondos usando `bo`, verificaste si alguna ave tenía una envergadura máxima superior a 500 y, de ser así, mostraste su etiqueta junto al punto. Desplazaste un poco las etiquetas en el eje y (`y * (1 - 0.05)`) y usaste el nombre del ave como etiqueta.
...
Tanto el Águila Calva como el Halcón de la Pradera, aunque probablemente sean aves muy grandes, parecen estar mal etiquetados, con un `0` extra añadido a su envergadura máxima. Es poco probable que encuentres un Águila Calva con una envergadura de 25 metros, pero si lo haces, ¡por favor avísanos! Creemos un nuevo dataframe sin esos dos valores atípicos:
...
Sin embargo, este gráfico de barras es ilegible porque hay demasiados datos no agrupados. Necesitas seleccionar solo los datos que deseas graficar, así que veamos la longitud de las aves según su categoría.
