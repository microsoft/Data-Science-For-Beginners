...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-05T06:06:25+00:00",
...
Začeli smo z definicijami podatkovne znanosti in etike, raziskali različna orodja in tehnike za analizo ter vizualizacijo podatkov, pregledali življenjski cikel podatkovne znanosti ter preučili možnosti za skaliranje in avtomatizacijo delovnih procesov podatkovne znanosti z uporabo storitev v oblaku. Verjetno se sprašujete: _"Kako lahko vse te nauke prenesem v resnične kontekste?"_

V tej lekciji bomo raziskali resnične aplikacije podatkovne znanosti v industriji ter se poglobili v specifične primere v raziskovalnih, digitalno-humanističnih in trajnostnih kontekstih. Pregledali bomo priložnosti za študentske projekte in zaključili z uporabnimi viri, ki vam bodo pomagali nadaljevati vaše učno potovanje!

## Predhodni kviz

[Predhodni kviz](https://ff-quizzes.netlify.app/en/ds/)
 ...
 * [Uber Data Science Workbench](https://eng.uber.com/dsw/) - uporablja podatke (o lokacijah prevzemov in odhodov, trajanju voženj, priljubljenih poteh itd.), zbrane iz milijonov Uber voženj *dnevno*, za izdelavo orodja za analizo podatkov, ki pomaga pri določanju cen, varnosti, odkrivanju goljufij in navigacijskih odločitvah.
...
Za študente ti raziskovalni projekti ponujajo priložnosti za učenje in sodelovanje, ki lahko izboljšajo vaše razumevanje teme ter razširijo vašo ozaveščenost in povezovanje z relevantnimi ljudmi ali ekipami, ki delajo na področjih vašega interesa. Kako izgledajo raziskovalni projekti in kakšen vpliv lahko imajo?
...
**Ključni rezultati:** Povečana ozaveščenost, da podatkovna znanost potrebuje _reprezentativnejše podatkovne zbirke_ (uravnotežene podskupine) in _vključujoče ekipe_ (raznolika ozadja), da bi pristranskosti prepoznali in odpravili ali zmanjšali že zgodaj v rešitvah umetne inteligence. Takšna raziskovalna prizadevanja so ključna tudi za številne organizacije pri oblikovanju načel in praks za _odgovorno umetno inteligenco_, da bi izboljšali pravičnost v svojih izdelkih in procesih umetne inteligence.
 ...
 * [Hub](https://planetarycomputer.microsoft.com/docs/overview/environment/) - upravljano okolje za znanstvenike za obdelavo masivnih geospacijskih podatkovnih zbirk.
...
* [MSR Data Science Summer School](https://www.microsoft.com/en-us/research/academic-program/data-science-summer-school/#!projects) z GitHub [projekti](https://github.com/msr-ds3), ki raziskujejo teme, kot so:
    ...
    - [Zanesljivost sistema podzemne železnice v NYC](https://www.microsoft.com/en-us/research/video/data-science-summer-school-2018-exploring-the-reliability-of-the-nyc-subway-system/) | [Github](https://github.com/msr-ds3/nyctransit)
