...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-05T06:03:25+00:00",
...
V tej lekciji lahko uporabite Seaborn, ki ste ga že uporabljali, kot odlično knjižnico za vizualizacijo odnosov med spremenljivkami. Še posebej zanimiva je uporaba funkcije `relplot` v Seabornu, ki omogoča razpršene grafe in črtne grafe za hitro vizualizacijo '[statističnih odnosov](https://seaborn.pydata.org/tutorial/relational.html?highlight=relationships)', kar podatkovnemu znanstveniku omogoča boljše razumevanje, kako se spremenljivke med seboj povezujejo.
...
S to spremembo barvne sheme lahko vidite, da je očitno močan napredek skozi leta glede cene medu na funt. Če pogledate vzorec podatkov za preverjanje (izberite določeno državo, na primer Arizono), lahko opazite vzorec zviševanja cen iz leta v leto, z nekaj izjemami:
...
Drug način za vizualizacijo tega napredka je uporaba velikosti namesto barve. Za uporabnike z barvno slepoto je to morda boljša možnost. Uredite svojo vizualizacijo tako, da pokažete povečanje cene z večanjem obsega točk:
...
Vprašanje: Ali obstaja jasen porast cene medu na funt iz leta v leto? To lahko najlažje odkrijete z ustvarjanjem enega samega črtnega grafa:
...
![črtni graf 1](../../../../3-Data-Visualization/12-visualization-relationships/images/line1.png)

✅ Ker Seaborn združuje podatke okoli ene črte, prikazuje "več meritev pri vsaki vrednosti x z izrisovanjem povprečja in 95% intervala zaupanja okoli povprečja". [Vir](https://seaborn.pydata.org/tutorial/relational.html). To časovno zahtevno vedenje lahko onemogočite z dodajanjem `ci=None`.
...
![črtni graf 2](../../../../3-Data-Visualization/12-visualization-relationships/images/line2.png)
...
Mreže faset vzamejo en vidik vaše podatkovne zbirke (v našem primeru lahko izberete 'leto', da se izognete prevelikemu številu faset). Seaborn lahko nato ustvari graf za vsako od teh faset vaših izbranih koordinat x in y za lažjo vizualno primerjavo. Ali leto 2003 izstopa v tej vrsti primerjave?
...
Poskusite večvrstni graf z nadgradnjo dveh črtnih grafov enega na drugega, z uporabo Seabornove funkcije 'despine' za odstranitev zgornjih in desnih hrbtenic ter z uporabo `ax.twinx` [izpeljano iz Matplotlib](https://matplotlib.org/stable/api/_as_gen/matplotlib.axes.Axes.twinx.html). Twinx omogoča grafu, da deli os x in prikaže dve osi y. Torej, prikažite donos na kolonijo in število kolonij, nadgrajeno:
...
Čeprav nič ne izstopa okoli leta 2003, nam to omogoča, da zaključimo to lekcijo na nekoliko bolj veseli noti: čeprav je število kolonij na splošno v upadu, se število kolonij stabilizira, tudi če njihov donos na kolonijo upada.
...
## [Naknadni kviz](https://ff-quizzes.netlify.app/en/ds/)

## Pregled in samostojno učenje

Črtni grafi so lahko preprosti ali precej kompleksni. Malo preberite v [dokumentaciji Seaborn](https://seaborn.pydata.org/generated/seaborn.lineplot.html) o različnih načinih, kako jih lahko zgradite. Poskusite izboljšati črtne grafe, ki ste jih zgradili v tej lekciji, z drugimi metodami, navedenimi v dokumentaciji.
## Naloga
