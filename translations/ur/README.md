...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T13:28:49+00:00",
...
Azure Cloud Advocates نے Microsoft میں ایک 10 ہفتوں کا، 20 اسباق پر مشتمل نصاب پیش کیا ہے جو مکمل طور پر ڈیٹا سائنس کے بارے میں ہے۔ ہر سبق میں پیشگی اور بعد از سبق کوئز، سبق مکمل کرنے کے لیے تحریری ہدایات، ایک حل، اور ایک اسائنمنٹ شامل ہے۔ ہمارا پروجیکٹ پر مبنی طریقہ کار آپ کو سیکھنے کے دوران تخلیق کرنے کی اجازت دیتا ہے، جو نئے ہنر کو یاد رکھنے کا ایک مؤثر طریقہ ہے۔
...
- **[شراکت گائیڈ](CONTRIBUTING.md)** - اس پروجیکٹ میں تعاون کرنے کا طریقہ
...
> **[طلباء](https://aka.ms/student-page)**: اس نصاب کو خود استعمال کرنے کے لیے، پورے ریپو کو فورک کریں اور خود سے مشقیں مکمل کریں، ایک پری لیکچر کوئز سے شروع کریں۔ پھر لیکچر پڑھیں اور باقی سرگرمیاں مکمل کریں۔ کوشش کریں کہ اسباق کو سمجھ کر پروجیکٹس بنائیں بجائے اس کے کہ حل کوڈ کو کاپی کریں؛ تاہم، وہ کوڈ ہر پروجیکٹ پر مبنی سبق کے /solutions فولڈرز میں دستیاب ہے۔ ایک اور خیال یہ ہو سکتا ہے کہ دوستوں کے ساتھ ایک اسٹڈی گروپ بنائیں اور مواد کو ایک ساتھ دیکھیں۔ مزید مطالعہ کے لیے، ہم [Microsoft Learn](https://docs.microsoft.com/en-us/users/jenlooper-2911/collections/qprpajyoy3x0g7?WT.mc_id=academic-77958-bethanycheum) کی سفارش کرتے ہیں۔
...
> **اساتذہ**: ہم نے اس نصاب کو استعمال کرنے کے بارے میں [کچھ تجاویز شامل کی ہیں](for-teachers.md)۔ ہمیں آپ کی رائے [ہمارے بحث فورم](https://github.com/microsoft/Data-Science-For-Beginners/discussions) میں پسند آئے گی!
...
> 🎥 اوپر دی گئی تصویر پر کلک کریں پروجیکٹ اور اسے بنانے والے افراد کے بارے میں ویڈیو دیکھنے کے لیے!
...
اس کے علاوہ، کلاس سے پہلے ایک کم دباؤ والا کوئز طالب علم کو موضوع سیکھنے کی نیت پر مرکوز کرتا ہے، جبکہ کلاس کے بعد دوسرا کوئز مزید یادداشت کو یقینی بناتا ہے۔ یہ نصاب لچکدار اور دلچسپ بنایا گیا ہے اور اسے مکمل یا جزوی طور پر لیا جا سکتا ہے۔ منصوبے چھوٹے شروع ہوتے ہیں اور 10 ہفتوں کے اختتام تک بتدریج پیچیدہ ہو جاتے ہیں۔
...
**ڈیٹا سائنس میں نئے ہیں؟** ہم نے ایک خاص [examples directory](examples/README.md) بنایا ہے جس میں سادہ، اچھی طرح سے تبصرہ شدہ کوڈ شامل ہے تاکہ آپ کو شروع کرنے میں مدد ملے:
...
ہر مثال میں ہر قدم کی تفصیل سے وضاحت شامل ہے، جو اسے بالکل ابتدائی افراد کے لیے بہترین بناتی ہے!
...
| 09 | مقداروں کو بصری بنانا | [ڈیٹا کی بصریات](3-Data-Visualization/README.md) | Matplotlib کا استعمال کرتے ہوئے پرندوں کے ڈیٹا کو بصری بنانا سیکھیں 🦆 | [سبق](3-Data-Visualization/09-visualization-quantities/README.md) | [Jen](https://twitter.com/jenlooper) |
| 10 | ڈیٹا کی تقسیم کو بصری بنانا | [ڈیٹا کی بصریات](3-Data-Visualization/README.md) | وقفے کے اندر مشاہدات اور رجحانات کو بصری بنانا۔ | [سبق](3-Data-Visualization/10-visualization-distributions/README.md) | [Jen](https://twitter.com/jenlooper) |
| 11 | تناسب کو بصری بنانا | [ڈیٹا کی بصریات](3-Data-Visualization/README.md) | الگ اور گروپ شدہ فیصد کو بصری بنانا۔ | [سبق](3-Data-Visualization/11-visualization-proportions/README.md) | [Jen](https://twitter.com/jenlooper) |
| 12 | تعلقات کو بصری بنانا | [ڈیٹا کی بصریات](3-Data-Visualization/README.md) | ڈیٹا کے سیٹوں اور ان کے متغیرات کے درمیان تعلقات اور ارتباط کو بصری بنانا۔ | [سبق](3-Data-Visualization/12-visualization-relationships/README.md) | [Jen](https://twitter.com/jenlooper) |
| 13 | بامعنی بصریات | [ڈیٹا کی بصریات](3-Data-Visualization/README.md) | مسئلے کو مؤثر طریقے سے حل کرنے اور بصیرت کے لیے اپنی بصریات کو قیمتی بنانے کے لیے تکنیک اور رہنمائی۔ | [سبق](3-Data-Visualization/13-meaningful-visualizations/README.md) | [Jen](https://twitter.com/jenlooper) |
...
| 20 | جنگلی میں ڈیٹا سائنس | [جنگلی میں](6-Data-Science-In-Wild/README.md) | حقیقی دنیا میں ڈیٹا سائنس سے چلنے والے منصوبے۔ | [سبق](6-Data-Science-In-Wild/20-Real-World-Examples/README.md) | [Nitya](https://twitter.com/nitya) |
...
- [نئے افراد کے لیے XR ڈیولپمنٹ](https://github.com/microsoft/xr-development-for-beginners)  
...
اگر آپ کہیں پھنس جائیں یا AI ایپس بنانے کے بارے میں سوالات ہوں، تو شامل ہوں:  

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)  

اگر آپ کے پاس پروڈکٹ کے بارے میں فیڈبیک ہو یا ایپس بنانے کے دوران کوئی خرابی ہو، تو یہاں جائیں:  
