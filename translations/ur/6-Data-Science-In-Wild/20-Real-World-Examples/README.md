...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T16:07:43+00:00",
 ...
 * [گوگل فلو ٹرینڈز](https://www.wired.com/2015/10/can-learn-epic-failure-google-flu-trends/) نے ڈیٹا سائنس کا استعمال کرتے ہوئے تلاش کے الفاظ کو فلو کے رجحانات سے جوڑا۔ اگرچہ اس طریقہ کار میں خامیاں تھیں، لیکن اس نے ڈیٹا سے چلنے والی صحت کی پیش گوئیوں کے امکانات (اور چیلنجز) کے بارے میں آگاہی پیدا کی۔
 ...
 * [NYC ٹیکسی کیب روٹ بصریات](http://chriswhong.github.io/nyctaxi/) - [آزادی معلومات کے قوانین](https://chriswhong.com/open-data/foil_nyc_taxi/) کے ذریعے جمع کردہ ڈیٹا نے NYC کیبس کی زندگی کے ایک دن کو بصری بنایا، جس سے ہمیں یہ سمجھنے میں مدد ملی کہ وہ مصروف شہر میں کیسے نیویگیٹ کرتے ہیں، وہ کتنی رقم کماتے ہیں، اور ہر 24 گھنٹے کی مدت میں سفر کا دورانیہ۔

 * [اوبر ڈیٹا سائنس ورک بینچ](https://eng.uber.com/dsw/) - روزانہ لاکھوں اوبر سفر سے جمع کردہ ڈیٹا (پک اپ اور ڈراپ آف مقامات، سفر کا دورانیہ، ترجیحی راستے وغیرہ) کا استعمال کرتے ہوئے قیمتوں، حفاظت، دھوکہ دہی کی شناخت اور نیویگیشن کے فیصلوں میں مدد کے لیے ڈیٹا تجزیاتی ٹول تیار کرتا ہے۔
...
جبکہ حقیقی دنیا کے اطلاقات اکثر صنعت کے بڑے پیمانے پر استعمال کے معاملات پر توجہ مرکوز کرتے ہیں، _تحقیق_ کے اطلاقات اور پروجیکٹس دو نقطہ نظر سے مفید ہو سکتے ہیں:
...
طلباء کے لیے، یہ تحقیقی پروجیکٹس سیکھنے اور تعاون کے مواقع فراہم کر سکتے ہیں جو آپ کی موضوع کی سمجھ کو بہتر بنا سکتے ہیں، اور متعلقہ افراد یا ٹیموں کے ساتھ آپ کی آگاہی اور مشغولیت کو وسیع کر سکتے ہیں جو دلچسپی کے شعبوں میں کام کر رہے ہیں۔ تو تحقیقی پروجیکٹس کیسے نظر آتے ہیں اور وہ کیسے اثر ڈال سکتے ہیں؟

آئیے ایک مثال دیکھتے ہیں - [MIT جنس کے شیڈز اسٹڈی](http://gendershades.org/overview.html) جوائے بولااموینی (MIT میڈیا لیبز) کی طرف سے ایک [دستخطی تحقیقی مقالہ](http://proceedings.mlr.press/v81/buolamwini18a/buolamwini18a.pdf) کے ساتھ، جو ٹمنیت گیبرو (اس وقت مائیکروسافٹ ریسرچ میں) کے ساتھ شریک مصنف تھا، جس نے توجہ مرکوز کی:
 ...
 * **کیوں:** چہرے کا تجزیہ قانون نافذ کرنے، ہوائی اڈے کی حفاظت، بھرتی کے نظام اور مزید جیسے شعبوں میں استعمال ہوتا ہے - ایسے سیاق و سباق جہاں غلط درجہ بندی (جیسے تعصب کی وجہ سے) متاثرہ افراد یا گروہوں کو ممکنہ اقتصادی اور سماجی نقصانات پہنچا سکتی ہے۔ انصاف کو یقینی بنانے کے لیے تعصبات کو سمجھنا (اور ختم یا کم کرنا) کلیدی ہے۔
 * **کیسے:** محققین نے تسلیم کیا کہ موجودہ بینچ مارکس بنیادی طور پر ہلکی جلد والے مضامین استعمال کرتے ہیں، اور ایک نیا ڈیٹا سیٹ (1000+ تصاویر) تیار کیا جو جنس اور جلد کی قسم کے لحاظ سے _زیادہ متوازن_ تھا۔ ڈیٹا سیٹ کو تین جنس کی درجہ بندی کی مصنوعات (مائیکروسافٹ، IBM اور Face++ سے) کی درستگی کا جائزہ لینے کے لیے استعمال کیا گیا۔
...
**اہم نتائج:** یہ آگاہی پیدا کی کہ ڈیٹا سائنس کو زیادہ _نمائندہ ڈیٹا سیٹس_ (متوازن ذیلی گروپ) اور زیادہ _شامل ٹیموں_ (متنوع پس منظر) کی ضرورت ہے تاکہ AI حل میں ایسے تعصبات کو جلد پہچاننے اور ختم یا کم کرنے میں مدد ملے۔ اس طرح کی تحقیقی کوششیں بہت سی تنظیموں کے لیے _ذمہ دار AI_ کے اصولوں اور طریقوں کی وضاحت میں بھی اہم ہیں تاکہ ان کے AI مصنوعات اور عمل میں انصاف کو بہتر بنایا جا سکے۔

**مائیکروسافٹ میں متعلقہ تحقیقی کوششوں کے بارے میں جاننا چاہتے ہیں؟**

* [مائیکروسافٹ ریسرچ پروجیکٹس](https://www.microsoft.com/research/research-area/artificial-intelligence/?facet%5Btax%5D%5Bmsr-research-area%5D%5B%5D=13556&facet%5Btax%5D%5Bmsr-content-type%5D%5B%5D=msr-project) پر ایک نظر ڈالیں۔
* [مائیکروسافٹ ریسرچ ڈیٹا سائنس سمر اسکول](https://www.microsoft.com/en-us/research/academic-program/data-science-summer-school/) کے طلباء کے پروجیکٹس کو دریافت کریں۔
...
ڈیجیٹل ہیومینٹیز [کی تعریف کی گئی ہے](https://digitalhumanities.stanford.edu/about-dh-stanford) "ایک مجموعہ کے طور پر جو کمپیوٹیشنل طریقوں کو انسانی تحقیق کے ساتھ جوڑتا ہے"۔ [اسٹینفورڈ پروجیکٹس](https://digitalhumanities.stanford.edu/projects) جیسے _"تاریخ کو دوبارہ شروع کرنا"_ اور _"شاعرانہ سوچ"_ ڈیجیٹل ہیومینٹیز اور ڈیٹا سائنس کے درمیان تعلق کو ظاہر کرتے ہیں - نیٹ ورک تجزیہ، معلومات کی بصریات، مکانی اور متن تجزیہ جیسی تکنیکوں پر زور دیتے ہیں جو ہمیں تاریخی اور ادبی ڈیٹا سیٹس کو دوبارہ دیکھنے اور نئے بصیرت اور نقطہ نظر حاصل کرنے میں مدد دے سکتے ہیں۔

*کیا آپ اس جگہ میں کسی پروجیکٹ کو دریافت اور بڑھانا چاہتے ہیں؟*

["ایملی ڈکنسن اور موڈ کا میٹر"](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671) کو دیکھیں - [جین لوپر](https://twitter.com/jenlooper) کی طرف سے ایک بہترین مثال جو پوچھتی ہے کہ ہم ڈیٹا سائنس کا استعمال کرتے ہوئے مانوس شاعری کو دوبارہ دیکھ سکتے ہیں اور اس کے معنی اور اس کے مصنف کی شراکت کو نئے سیاق و سباق میں دوبارہ جانچ سکتے ہیں۔ مثال کے طور پر، _کیا ہم شاعری کے لہجے یا جذبات کا تجزیہ کرکے یہ پیش گوئی کر سکتے ہیں کہ ایک نظم کس موسم میں لکھی گئی تھی_ - اور اس سے ہمیں متعلقہ مدت کے دوران مصنف کی ذہنی حالت کے بارے میں کیا پتہ چلتا ہے؟

اس سوال کا جواب دینے کے لیے، ہم اپنے ڈیٹا سائنس لائف سائیکل کے مراحل پر عمل کرتے ہیں:
 * [`ڈیٹا حاصل کرنا`](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671#acquiring-the-dataset) - تجزیہ کے لیے متعلقہ ڈیٹا سیٹ جمع کرنا۔ اختیارات میں API کا استعمال (جیسے [Poetry DB API](https://poetrydb.org/index.html)) یا ویب صفحات کو اسکریپ کرنا (جیسے [پروجیکٹ گٹنبرگ](https://www.gutenberg.org/files/12242/12242-h/12242-h.htm)) شامل ہیں۔
 * [`ڈیٹا صاف کرنا`](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671#clean-the-data) - وضاحت کرتا ہے کہ متن کو کیسے فارمیٹ، صاف اور آسان بنایا جا سکتا ہے، بنیادی آلات جیسے Visual Studio Code اور Microsoft Excel کا استعمال کرتے ہوئے۔
 * [`ڈیٹا تجزیہ`](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671#working-with-the-data-in-a-notebook) - وضاحت کرتا ہے کہ ہم اب ڈیٹا سیٹ کو "نوٹ بکس" میں تجزیہ کے لیے کیسے درآمد کر سکتے ہیں، Python پیکجز (جیسے pandas، numpy اور matplotlib) کا استعمال کرتے ہوئے ڈیٹا کو منظم اور بصری بنانے کے لیے۔
 * [`جذبات کا تجزیہ`](https://gist.github.com/jlooper/ce4d102efd057137bc000db796bfd671#sentiment-analysis-using-cognitive-services) - وضاحت کرتا ہے کہ ہم کلاؤڈ سروسز جیسے Text Analytics کو کیسے شامل کر سکتے ہیں، کم کوڈ والے آلات جیسے [Power Automate](https://flow.microsoft.com/en-us/) کا استعمال کرتے ہوئے خودکار ڈیٹا پروسیسنگ ورک فلو کے لیے۔
...
[2030 کے پائیدار ترقی کے ایجنڈا](https://sdgs.un.org/2030agenda) - جو 2015 میں تمام اقوام متحدہ کے اراکین نے اپنایا - 17 اہداف کی نشاندہی کرتا ہے، جن میں **سیارے کی حفاظت** کو انحطاط اور موسمیاتی تبدیلی کے اثرات سے شامل کیا گیا ہے۔ [مائیکروسافٹ پائیداری](https://www.microsoft.com/en-us/sustainability) اقدام ان اہداف کی حمایت کرتا ہے، ٹیکنالوجی کے حل کے ذریعے زیادہ پائیدار مستقبل کی تعمیر کے طریقوں کو تلاش کرتے ہوئے، [4 اہداف پر توجہ مرکوز کرتے ہوئے](https://dev.to/azure/a-visual-guide-to-sustainable-software-engineering-53hh) - 2030 تک کاربن منفی، پانی مثبت، صفر فضلہ، اور حیاتیاتی تنوع۔

ان چیلنجوں کو بڑے پیمانے پر اور بروقت انداز میں حل کرنے کے لیے کلاؤڈ پیمانے کی سوچ اور بڑے پیمانے پر ڈیٹا کی ضرورت ہوتی ہے۔ [سیاروی کمپیوٹر](https://planetarycomputer.microsoft.com/) اقدام ڈیٹا سائنسدانوں اور ڈویلپرز کو اس کوشش میں مدد کے لیے 4 اجزاء فراہم کرتا ہے:
 ...
 * [سیاروی API](https://planetarycomputer.microsoft.com/docs/reference/stac/) - صارفین کو خلا اور وقت کے لحاظ سے متعلقہ ڈیٹا تلاش کرنے میں مدد کرنے کے لیے۔
 ...
 * [اطلاقات](https://planetarycomputer.microsoft.com/applications) - پائیداری کے بصیرت کے لیے استعمال کے معاملات اور آلات کو ظاہر کرتا ہے۔
...
* [رسائی کی درخواست کریں](https://planetarycomputer.microsoft.com/account/request) تاکہ تحقیق شروع کی جا سکے اور ساتھیوں سے جڑ سکیں۔
...
ایسے مضامین تلاش کریں جو ڈیٹا سائنس کے ابتدائی دوستانہ پروجیکٹس کی سفارش کرتے ہیں - جیسے [یہ 50 موضوعاتی علاقے](https://www.upgrad.com/blog/data-science-project-ideas-topics-beginners/) یا [یہ 21 پروجیکٹ آئیڈیاز](https://www.intellspot.com/data-science-project-ideas) یا [یہ 16 پروجیکٹس سورس کوڈ کے ساتھ](https://data-flair.training/blogs/data-science-project-ideas/) جنہیں آپ تجزیہ کر کے دوبارہ ترتیب دے سکتے ہیں۔ اور اپنی سیکھنے کے سفر کے بارے میں بلاگ کرنا نہ بھولیں اور اپنی بصیرت ہم سب کے ساتھ شیئر کریں۔
