...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T22:01:08+00:00",
...
[![Kako grafikoni lažu, autor Alberto Cairo](../../../../3-Data-Visualization/13-meaningful-visualizations/images/tornado.png)](https://www.youtube.com/watch?v=oX74Nge8Wkw "Kako grafikoni lažu")
...
Važno je razumjeti koliko lako oko može biti zavarano obmanjujućim grafikonima. Čak i ako je namjera podatkovnog znanstvenika dobra, odabir lošeg tipa grafikona, poput pita grafikona s previše kategorija, može biti obmanjujući.
...
Budite oprezni pri odabiru boja za svoj grafikon, jer boja može prenijeti značenje koje možda niste namjeravali. 'Pink ladies' u grafikonu 'visina' iznad prenose izrazito 'žensko' značenje koje dodatno doprinosi bizarnosti samog grafikona.
...
Ako su vaši podaci tekstualni i opširni na X osi, možete zakrenuti tekst radi bolje čitljivosti. [Matplotlib](https://matplotlib.org/stable/tutorials/toolkits/mplot3d.html) nudi 3D grafičke prikaze, ako vaši podaci to podržavaju. Sofisticirane vizualizacije podataka mogu se izraditi pomoću `mpl_toolkits.mplot3d`.
...
> "Les Liaisons Dangereuses" je epistolarni roman, odnosno roman predstavljen kao niz pisama. Napisao ga je 1782. godine Choderlos de Laclos, a priča govori o zlobnim, moralno bankrotiranim društvenim manevrima dvoje suparnika francuskog plemstva u kasnom 18. stoljeću, vikonta de Valmonta i markize de Merteuil. Oboje na kraju doživljavaju propast, ali ne bez nanošenja velike društvene štete. Roman se odvija kao niz pisama napisanih raznim osobama iz njihovih krugova, planirajući osvetu ili jednostavno stvarajući probleme. Izradite vizualizaciju ovih pisama kako biste otkrili glavne aktere priče, vizualno.
...
3. Dovršite kod u `components/Nodes.vue` kako biste omogućili vizualizaciju. Pronađite metodu pod nazivom `createLinks()` i dodajte sljedeću ugniježđenu petlju.
