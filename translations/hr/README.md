...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T14:42:25+00:00",
...
Azure Cloud Advocates u Microsoftu s ponosom predstavljaju 10-tjedni kurikulum s 20 lekcija o znanosti o podacima. Svaka lekcija uključuje kvizove prije i poslije lekcije, pisane upute za dovršavanje lekcije, rješenje i zadatak. Naš projektno orijentirani pristup omogućuje vam učenje kroz izradu, što je dokazano učinkovit način za usvajanje novih vještina.
...
**🙏 Posebna zahvala 🙏 našim [Microsoft Student Ambassador](https://studentambassadors.microsoft.com/) autorima, recenzentima i suradnicima,** uključujući Aaryan Arora, [Aditya Garg](https://github.com/AdityaGarg00), [Alondra Sanchez](https://www.linkedin.com/in/alondra-sanchez-molina/), [Ankita Singh](https://www.linkedin.com/in/ankitasingh007), [Anupam Mishra](https://www.linkedin.com/in/anupam--mishra/), [Arpita Das](https://www.linkedin.com/in/arpitadas01/), ChhailBihari Dubey, [Dibri Nsofor](https://www.linkedin.com/in/dibrinsofor), [Dishita Bhasin](https://www.linkedin.com/in/dishita-bhasin-7065281bb), [Majd Safi](https://www.linkedin.com/in/majd-s/), [Max Blum](https://www.linkedin.com/in/max-blum-6036a1186/), [Miguel Correa](https://www.linkedin.com/in/miguelmque/), [Mohamma Iftekher (Iftu) Ebne Jalal](https://twitter.com/iftu119), [Nawrin Tabassum](https://www.linkedin.com/in/nawrin-tabassum), [Raymond Wangsa Putra](https://www.linkedin.com/in/raymond-wp/), [Rohit Yadav](https://www.linkedin.com/in/rty2423), Samridhi Sharma, [Sanya Sinha](https://www.linkedin.com/mwlite/in/sanya-sinha-13aab1200),
...
Osim toga, kviz s niskim ulogom prije predavanja usmjerava studenta na učenje određene teme, dok drugi kviz nakon predavanja osigurava bolje zadržavanje naučenog. Ovaj kurikulum je osmišljen da bude fleksibilan i zabavan te se može pohađati u cijelosti ili djelomično. Projekti započinju jednostavno i postaju sve složeniji do kraja 10-tjednog ciklusa.
...
**Novi u Data Scienceu?** Kreirali smo posebnu [mapu s primjerima](examples/README.md) s jednostavnim, dobro komentiranim kodom kako bismo vam pomogli da započnete:

- 🌟 **Hello World** - Vaš prvi program za data science
...
|:---:|
| Data Science za početnike: Plan puta - _Sketchnote od [@nitya](https://twitter.com/nitya)_ |


| Broj lekcije | Tema | Grupiranje lekcija | Ciljevi učenja | Povezana lekcija | Autor |
| :-----------: | :----------------------------------------: | :--------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------: | :----: |
| 01 | Definiranje Data Sciencea | [Uvod](1-Introduction/README.md) | Naučite osnovne pojmove vezane uz data science i kako je povezan s umjetnom inteligencijom, strojnim učenjem i velikim podacima. | [lekcija](1-Introduction/01-defining-data-science/README.md) [video](https://youtu.be/beZ7Mb_oz9I) | [Dmitry](http://soshnikov.com) |
...
| 08 | Priprema podataka | [Rad s podacima](2-Working-With-Data/README.md) | Teme o tehnikama za čišćenje i transformaciju podataka kako bi se riješili problemi s nedostajućim, netočnim ili nepotpunim podacima. | [lekcija](2-Working-With-Data/08-data-preparation/README.md) | [Jasmine](https://www.twitter.com/paladique) |
...
| 13 | Smisleno vizualiziranje | [Vizualizacija podataka](3-Data-Visualization/README.md) | Tehnike i smjernice za izradu vizualizacija koje su vrijedne za učinkovito rješavanje problema i uvid. | [lekcija](3-Data-Visualization/13-meaningful-visualizations/README.md) | [Jen](https://twitter.com/jenlooper) |
...
| 15 | Analiziranje | [Životni ciklus](4-Data-Science-Lifecycle/README.md) | Ova faza životnog ciklusa data sciencea fokusira se na tehnike za analizu podataka. | [lekcija](4-Data-Science-Lifecycle/15-analyzing/README.md) | [Jasmine](https://twitter.com/paladique) | | |
...
- [Razvoj XR-a za početnike](https://github.com/microsoft/xr-development-for-beginners)
...
**Imate problema?** Pogledajte naš [Vodič za rješavanje problema](TROUBLESHOOTING.md) za rješenja uobičajenih poteškoća.
