...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-05T18:59:16+00:00",
...
Да бисте преузели податке, користите команду `SELECT`. У својој основи, **изаберете** колоне које желите да видите **из** табеле у којој се налазе. Ако желите да прикажете само имена градова, можете користити следеће:
