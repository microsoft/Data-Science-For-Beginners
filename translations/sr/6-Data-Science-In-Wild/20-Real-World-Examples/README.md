...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-05T06:23:11+00:00",
...
Почели смо са дефиницијама науке о подацима и етике, истражили различите алате и технике за анализу и визуализацију података, прегледали животни циклус науке о подацима и погледали како се процеси науке о подацима могу скалирати и аутоматизовати уз помоћ услуга облачног рачунарства. Дакле, вероватно се питате: _"Како тачно могу да применим све ово знање у стварним контекстима?"_

У овој лекцији истражићемо примену науке о подацима у различитим индустријама и дубље се упустити у конкретне примере из области истраживања, дигиталних хуманистичких наука и одрживости. Погледаћемо могућности студентских пројеката и закључити са корисним ресурсима који ће вам помоћи да наставите своје путовање учења!
...
Док се апликације у стварном свету често фокусирају на индустријске случајеве употребе у великом обиму, апликације и пројекти у _истраживању_ могу бити корисни из две перспективе:
...
Погледајмо један пример - [MIT Gender Shades Study](http://gendershades.org/overview.html) од Џој Буоламвини (MIT Media Labs) са [истакнутим истраживачким радом](http://proceedings.mlr.press/v81/buolamwini18a/buolamwini18a.pdf) који је коауторисао Тимнит Гебру (тада у Microsoft Research) који се фокусирао на:

 * **Шта:** Циљ истраживачког пројекта био је _проценити пристрасност присутну у алгоритмима и скуповима података за аутоматску анализу лица_ на основу пола и типа коже.
...
Резултати су показали да, иако је укупна тачност класификације била добра, постојала је приметна разлика у стопама грешака између различитих подгрупа - са **погрешним одређивањем пола** које је било чешће код жена или особа тамније коже, што указује на пристрасност.

**Кључни резултати:** Подигнута је свест да наука о подацима захтева више _репрезентативних скупова података_ (уравнотежене подгрупе) и више _инклузивних тимова_ (разнолике позадине) како би се препознале и елиминисале или ублажиле такве пристрасности раније у AI решењима. Истраживачки напори попут овог такође су кључни за многе организације у дефинисању принципа и пракси за _одговорну AI_ како би се побољшала правичност у њиховим AI производима и процесима.
...
* Истражите апликације као што је [Праћење екосистема](https://analytics-lab.org/ecosystemmonitoring/) за инспирацију о идејама за апликације.
...
Претражите чланке који препоручују пројекте из науке о подацима погодне за почетнике - као [ових 50 тема](https://www.upgrad.com/blog/data-science-project-ideas-topics-beginners/) или [ових 21 идеја за пројекте](https://www.intellspot.com/data-science-project-ideas) или [ових 16 пројеката са изворним кодом](https://data-flair.training/blogs/data-science-project-ideas/) које можете анализирати и прерадити. И не заборавите да пишете блогове о својим путовањима учења и поделите своје увиде са свима нама.
