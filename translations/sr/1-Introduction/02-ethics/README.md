...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-03T21:52:07+00:00",
...
Прикупљање података често укључује личне податке који могу идентификовати субјекте података. [Власништво над подацима](https://permission.io/blog/data-ownership) односи се на _контролу_ и [_права корисника_](https://permission.io/blog/data-ownership) у вези са креирањем, обрадом и ширењем података.
