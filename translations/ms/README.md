...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:50:00+00:00",
...
**Jika anda ingin mempunyai sokongan bahasa terjemahan tambahan, bahasa yang disokong disenaraikan [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
- [AI Generatif dengan Java](https://aka.ms/genaijava)
...
**Menghadapi masalah?** Semak [Panduan Penyelesaian Masalah](TROUBLESHOOTING.md) untuk penyelesaian kepada masalah biasa.  

Jika anda tersekat atau mempunyai soalan tentang membina aplikasi AI, sertai:  
