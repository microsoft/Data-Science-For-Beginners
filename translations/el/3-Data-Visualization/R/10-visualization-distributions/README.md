...
```
![μέγιστο μήκος ανά τάξη](../../../../../translated_images/el/max-length-per-order.e5b283d952c78c12b091307c5d3cf67132dad6fefe80a073353b9dc5c2bd3eb8.png)
...
```
![κατανομή σε όλο το σύνολο δεδομένων](../../../../../translated_images/el/distribution-over-the-entire-dataset.d22afd3fa96be854e4c82213fedec9e3703cba753d07fad4606aadf58cf7e78e.png)
...
![κατανομή-30 κάδοι](../../../../../translated_images/el/distribution-30bins.6a3921ea7a421bf71f06bf5231009e43d1146f1b8da8dc254e99b5779a4983e5.png)
...
![φιλτραρισμένο ιστόγραμμα](../../../../../translated_images/el/filtered-histogram.6bf5d2bfd82533220e1bd4bc4f7d14308f43746ed66721d9ec8f460732be6674.png)
...
![2d διάγραμμα](../../../../../translated_images/el/2d-plot.c504786f439bd7ebceebf2465c70ca3b124103e06c7ff7214bf24e26f7aec21e.png)
...
![άνοιγμα φτερών και κατάσταση διατήρησης](../../../../../translated_images/el/wingspan-conservation-collation.4024e9aa6910866aa82f0c6cb6a6b4b925bd10079e6b0ef8f92eefa5a6792f76.png)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![διάγραμμα πυκνότητας](../../../../../translated_images/el/density-plot.675ccf865b76c690487fb7f69420a8444a3515f03bad5482886232d4330f5c85.png)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![πυκνότητα μάζας σώματος](../../../../../translated_images/el/bodymass-smooth.d31ce526d82b0a1f19a073815dea28ecfbe58145ec5337e4ef7e8cdac81120b3.png)
...
```
![λιγότερο ομαλή μάζα σώματος](../../../../../translated_images/el/less-smooth-bodymass.10f4db8b683cc17d17b2d33f22405413142004467a1493d416608dafecfdee23.png)
...
```
![μάζα σώματος ανά τάξη](../../../../../translated_images/el/bodymass-per-order.9d2b065dd931b928c839d8cdbee63067ab1ae52218a1b90717f4bc744354f485.png)
