...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:31:27+00:00",
...
**Αν επιθυμείτε να υποστηριχθούν επιπλέον γλώσσες, οι υποστηριζόμενες γλώσσες παρατίθενται [εδώ](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
- **[Αντιμετώπιση Προβλημάτων](TROUBLESHOOTING.md)** - Λύσεις σε κοινά προβλήματα
...
## 👨‍🎓 Για Φοιτητές
> **Απόλυτοι Αρχάριοι**: Νέοι στην επιστήμη δεδομένων; Ξεκινήστε με τα [παραδείγματα φιλικά για αρχάριους](examples/README.md)! Αυτά τα απλά, καλά σχολιασμένα παραδείγματα θα σας βοηθήσουν να κατανοήσετε τα βασικά πριν προχωρήσετε στο πλήρες πρόγραμμα σπουδών.
...
4. Συμμετάσχετε στην [κοινότητα Discord](https://aka.ms/ds4beginners/discord) για υποστήριξη
...
> **Σημείωση για τα κουίζ**: Όλα τα κουίζ περιέχονται στον φάκελο Quiz-App, συνολικά 40 κουίζ με τρεις ερωτήσεις το καθένα. Συνδέονται μέσα από τα μαθήματα, αλλά η εφαρμογή κουίζ μπορεί να εκτελεστεί τοπικά ή να αναπτυχθεί στο Azure· ακολουθήστε τις οδηγίες στον φάκελο `quiz-app`. Σταδιακά μεταφράζονται.
...
1. Αν είναι η πρώτη φορά που χρησιμοποιείτε container ανάπτυξης, βεβαιωθείτε ότι το σύστημά σας πληροί τις προϋποθέσεις (π.χ. έχετε εγκατεστημένο το Docker) στην [τεκμηρίωση έναρξης](https://code.visualstudio.com/docs/devcontainers/containers#_getting-started).
...
- Επιλέξτε την κλωνοποιημένη έκδοση αυτού του φακέλου, περιμένετε να ξεκινήσει το container και δοκιμάστε τα.
...
**Αντιμετωπίζετε προβλήματα;** Ελέγξτε τον [Οδηγό Επίλυσης Προβλημάτων](TROUBLESHOOTING.md) για λύσεις σε κοινά προβλήματα.

Αν κολλήσετε ή έχετε ερωτήσεις σχετικά με την ανάπτυξη εφαρμογών Τεχνητής Νοημοσύνης, συμμετάσχετε σε συζητήσεις με άλλους μαθητές και έμπειρους προγραμματιστές σχετικά με το MCP. Είναι μια υποστηρικτική κοινότητα όπου οι ερωτήσεις είναι ευπρόσδεκτες και η γνώση μοιράζεται ελεύθερα.
