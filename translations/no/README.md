...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-06T10:58:05+00:00",
...
Azure Cloud Advocates hos Microsoft er glade for å tilby en 10-ukers, 20-leksjons læreplan om Data Science. Hver leksjon inkluderer quiz før og etter leksjonen, skriftlige instruksjoner for å fullføre leksjonen, en løsning og en oppgave. Vår prosjektbaserte pedagogikk lar deg lære mens du bygger, en velprøvd metode for å få nye ferdigheter til å sitte.
...
> **Lærere**: vi har [inkludert noen forslag](for-teachers.md) om hvordan du kan bruke denne læreplanen. Vi vil gjerne høre tilbakemeldingene dine [i vårt diskusjonsforum](https://github.com/microsoft/Data-Science-For-Beginners/discussions)!
