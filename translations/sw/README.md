...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:48:35+00:00",
...
#### Inayosaidiwa kupitia GitHub Action (Imejiendesha na Inasasishwa Kila Wakati)
...
- **[Mwongozo wa Matumizi](USAGE.md)** - Mifano na kazi za kawaida
- **[Utatuzi wa Shida](TROUBLESHOOTING.md)** - Suluhisho za matatizo ya kawaida
- **[Mwongozo wa Kuchangia](CONTRIBUTING.md)** - Jinsi ya kuchangia kwenye mradi huu
- **[Kwa Walimu](for-teachers.md)** - Mwongozo wa kufundisha na rasilimali za darasani

## 👨‍🎓 Kwa Wanafunzi
> **Wanaoanza Kabisa**: Mpya kwenye sayansi ya takwimu? Anza na [mifano rahisi kwa wanaoanza](examples/README.md)! Mifano hii rahisi, yenye maelezo mengi itakusaidia kuelewa misingi kabla ya kuingia kwenye mtaala kamili.
> **[Wanafunzi](https://aka.ms/student-page)**: kutumia mtaala huu peke yako, fanya fork ya repo nzima na ukamilishe mazoezi peke yako, ukianza na jaribio la kabla ya somo. Kisha soma somo na ukamilishe shughuli nyingine zote. Jaribu kuunda miradi kwa kuelewa masomo badala ya kunakili msimbo wa suluhisho; hata hivyo, msimbo huo unapatikana kwenye folda za /solutions katika kila somo linalohusiana na mradi. Wazo jingine ni kuunda kikundi cha kujifunza na marafiki na kupitia maudhui pamoja. Kwa masomo zaidi, tunapendekeza [Microsoft Learn](https://docs.microsoft.com/en-us/users/jenlooper-2911/collections/qprpajyoy3x0g7?WT.mc_id=academic-77958-bethanycheum).

**Anza Haraka:**
1. Angalia [Mwongozo wa Ufungaji](INSTALLATION.md) ili kusanidi mazingira yako
...
## Mbinu za Kufundisha
Tumechagua kanuni mbili za kielimu wakati wa kuunda mtaala huu: kuhakikisha kuwa ni wa msingi wa miradi na kwamba unajumuisha majaribio ya mara kwa mara. Kufikia mwisho wa mfululizo huu, wanafunzi watakuwa wamejifunza kanuni za msingi za sayansi ya data, ikiwa ni pamoja na dhana za kimaadili, maandalizi ya data, njia tofauti za kufanya kazi na data, uwasilishaji wa data, uchambuzi wa data, matumizi ya sayansi ya data katika maisha halisi, na zaidi.

Zaidi ya hayo, jaribio la kiwango cha chini kabla ya darasa huweka nia ya mwanafunzi kuelekea kujifunza mada, wakati jaribio la pili baada ya darasa huhakikisha uhifadhi zaidi wa maarifa. Mtaala huu umeundwa kuwa rahisi na wa kufurahisha na unaweza kuchukuliwa kwa ukamilifu au kwa sehemu. Miradi huanza kwa urahisi na kuwa changamano zaidi kufikia mwisho wa mzunguko wa wiki 10.
...
- Jaribio la awali la kujiandaa kabla ya somo
- Somo lililoandikwa
...
**Mgeni katika Sayansi ya Data?** Tumeunda [saraka ya mifano](examples/README.md) maalum yenye msimbo rahisi na maelezo ya kina ili kukusaidia kuanza:
...
- 🔬 **Mradi wa Maisha Halisi** - Mtiririko kamili wa kazi kutoka mwanzo hadi mwisho
...
|:---:|
| Sayansi ya Data kwa Wanaoanza: Ramani ya Njia - _Sketchnote na [@nitya](https://twitter.com/nitya)_ |
...
| 08 | Maandalizi ya Data | [Kufanya Kazi na Data](2-Working-With-Data/README.md) | Mada kuhusu mbinu za kusafisha na kubadilisha data ili kushughulikia changamoto za data iliyopotea, isiyo sahihi, au isiyokamilika. | [somo](2-Working-With-Data/08-data-preparation/README.md) | [Jasmine](https://www.twitter.com/paladique) |
| 09 | Uwasilishaji wa Kiasi | [Uwasilishaji wa Data](3-Data-Visualization/README.md) | Jifunze jinsi ya kutumia Matplotlib kuwasilisha data ya ndege 🦆 | [somo](3-Data-Visualization/09-visualization-quantities/README.md) | [Jen](https://twitter.com/jenlooper) |
| 10 | Uwasilishaji wa Usambazaji wa Data | [Uwasilishaji wa Data](3-Data-Visualization/README.md) | Kuonyesha uchunguzi na mwenendo ndani ya muda fulani. | [somo](3-Data-Visualization/10-visualization-distributions/README.md) | [Jen](https://twitter.com/jenlooper) |
| 11 | Uwasilishaji wa Uwiano | [Uwasilishaji wa Data](3-Data-Visualization/README.md) | Kuonyesha asilimia za vikundi na vilivyogawanyika. | [somo](3-Data-Visualization/11-visualization-proportions/README.md) | [Jen](https://twitter.com/jenlooper) |
| 12 | Uwasilishaji wa Mahusiano | [Uwasilishaji wa Data](3-Data-Visualization/README.md) | Kuonyesha uhusiano na ulinganifu kati ya seti za data na vigezo vyake. | [somo](3-Data-Visualization/12-visualization-relationships/README.md) | [Jen](https://twitter.com/jenlooper) |
| 13 | Uwasilishaji wa Maana | [Uwasilishaji wa Data](3-Data-Visualization/README.md) | Mbinu na mwongozo wa kufanya uwasilishaji wako kuwa wa thamani kwa utatuzi wa matatizo na ufahamu wa kina. | [somo](3-Data-Visualization/13-meaningful-visualizations/README.md) | [Jen](https://twitter.com/jenlooper) |
...
| 15 | Uchambuzi | [Mzunguko wa Maisha](4-Data-Science-Lifecycle/README.md) | Awamu hii ya mzunguko wa maisha wa sayansi ya data inazingatia mbinu za kuchambua data. | [somo](4-Data-Science-Lifecycle/15-analyzing/README.md) | [Jasmine](https://twitter.com/paladique) | | |
| 16 | Mawasiliano | [Mzunguko wa Maisha](4-Data-Science-Lifecycle/README.md) | Awamu hii ya mzunguko wa maisha wa sayansi ya data inazingatia kuwasilisha ufahamu kutoka kwa data kwa njia inayowarahisishia watoa maamuzi kuelewa. | [somo](4-Data-Science-Lifecycle/16-communication/README.md) | [Jalen](https://twitter.com/JalenMcG) | | |
...
| 20 | Sayansi ya Data katika Maisha Halisi | [Katika Maisha Halisi](6-Data-Science-In-Wild/README.md) | Miradi inayotokana na sayansi ya data katika maisha halisi. | [somo](6-Data-Science-In-Wild/20-Real-World-Examples/README.md) | [Nitya](https://twitter.com/nitya) |
...
Fuata hatua hizi kufungua repo hii kwenye kontena ukitumia mashine yako ya ndani na VSCode kwa kutumia kiendelezi cha VS Code Remote - Containers:
...
Ili kutumia hifadhi hii, unaweza kufungua hifadhi katika ujazo wa Docker uliojitenga:

**Kumbuka**: Chini ya kaputi, hii itatumia Remote-Containers: **Clone Repository in Container Volume...** amri ya kunakili msimbo wa chanzo katika ujazo wa Docker badala ya mfumo wa faili wa ndani. [Volumes](https://docs.docker.com/storage/volumes/) ni mbinu inayopendekezwa kwa kuhifadhi data ya kontena.
...
- Chagua nakala ya hifadhi hii, subiri kontena ianze, na ujaribu mambo.

## Ufikiaji wa Nje ya Mtandao

Unaweza kuendesha nyaraka hizi nje ya mtandao kwa kutumia [Docsify](https://docsify.js.org/#/). Nakili hifadhi hii, [sakinisha Docsify](https://docsify.js.org/#/quickstart) kwenye mashine yako ya ndani, kisha kwenye folda kuu ya hifadhi hii, andika `docsify serve`. Tovuti itahudumiwa kwenye bandari 3000 kwenye localhost yako: `localhost:3000`.
...
[![Maendeleo ya XR kwa Anayeanza](https://img.shields.io/badge/Maendeleo%20ya%20XR%20kwa%20Anayeanza-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)

---

### Mfululizo wa Copilot  
[![Copilot kwa Uandishi wa Programu kwa Kushirikiana na AI](https://img.shields.io/badge/Copilot%20kwa%20Uandishi%20wa%20Programu%20kwa%20Kushirikiana%20na%20AI-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
...
<!-- KOZI NYINGINE ZA CO-OP TRANSLATOR ZINAISHIA HAPA -->

## Kupata Msaada  

**Unakutana na changamoto?** Angalia [Mwongozo wa Utatuzi wa Shida](TROUBLESHOOTING.md) kwa suluhisho za matatizo ya kawaida.  

Ikiwa unakwama au una maswali kuhusu kujenga programu za AI, jiunge na wanafunzi wenzako na watengenezaji wenye uzoefu katika mijadala kuhusu MCP. Ni jamii inayosaidia ambapo maswali yanakaribishwa na maarifa yanashirikiwa kwa uhuru.  
