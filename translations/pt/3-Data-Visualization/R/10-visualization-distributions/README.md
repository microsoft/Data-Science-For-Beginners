...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-24T01:08:29+00:00",
...
Vamos descobrir alguns factos sobre as distribuições de dados neste conjunto. No teu console R, importa o `ggplot2` e a base de dados. Remove os outliers da base de dados, tal como fizeste no tópico anterior.
...
```
![comprimento máximo por ordem](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/max-length-per-order.png)
...
![distribuição-30bins](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/distribution-30bins.png)
...
Cria um histograma 2D para comparar a relação entre duas distribuições. Vamos comparar `MaxBodyMass` com `MaxLength`. O `ggplot2` oferece uma forma integrada de mostrar convergência usando cores mais brilhantes:
...
![envergadura e conservação](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/wingspan-conservation-collation.png)
...
ggplot(data = birds_filtered_1, aes(x = MinWingspan)) + 
  geom_density()
```
![gráfico de densidade](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/density-plot.png)
...
ggplot(data = birds_filtered_1, aes(x = MaxBodyMass)) + 
  geom_density()
```
![densidade de massa corporal](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/bodymass-smooth.png)
...
```
![massa corporal menos suave](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/less-smooth-bodymass.png)
...
```
![massa corporal por ordem](../../../../../3-Data-Visualization/R/10-visualization-distributions/images/bodymass-per-order.png)
