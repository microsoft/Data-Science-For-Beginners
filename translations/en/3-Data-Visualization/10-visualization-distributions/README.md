...
plt.show()
```
![max length per order](../../../../translated_images/en/scatter-wb.9d98b0ed7f0388af.webp)
...
plt.show()
```
![distribution over the entire dataset](../../../../translated_images/en/dist1-wb.0d0cac82e2974fbb.webp)
...
plt.show()
```
![distribution over the entire dataset with larger bins param](../../../../translated_images/en/dist2-wb.2c0a7a3499b2fbf5.webp)
...
plt.show()     
```
![filtered histogram](../../../../translated_images/en/dist3-wb.64b88db7f9780200.webp)
...
![2D plot](../../../../translated_images/en/2D-wb.ae22fdd33936507a.webp)
...
![wingspan and conservation collation](../../../../translated_images/en/histogram-conservation-wb.3c40450eb072c14d.webp)
...
plt.show()
```
![Density plot](../../../../translated_images/en/density1.8801043bd4af2567.webp)
...
plt.show()
```
![smooth bodymass line](../../../../translated_images/en/density2.8e7647257060ff54.webp)
...
plt.show()
```
![less smooth bodymass line](../../../../translated_images/en/density3.84ae27da82f31e6b.webp)
...
![bodymass per order](../../../../translated_images/en/density4.e9d6c033f15c500f.webp)
...
![multiple densities, superimposed](../../../../translated_images/en/multi.56548caa9eae8d0f.webp)
